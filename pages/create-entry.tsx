...
// import DataEntryForm from '../components/Input/DataEntry';

import { useState, useRef, ReactElement } from "react";
import { useForm } from "react-hook-form";
// import { firestore } from '../../config/firebase';
import Entry from "../components/Input/Entry";
...
export default function CreateEntry() {
    ...
    const onSubmit = (data: inputData) => {
        ...
        setEntries([
            {
                timestamp: [new Date()],
                stressLevel: data.stressLevelInput,
                content: data.entryInput,
            },
            ...entries,
        ]);
    };
    ...
    return (
        <div className="inline-block w-2/5">
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                    <label htmlFor="entryInput">Tell me something good: </label>
                    <button
                        type="submit"
            ...
            <button
                type="button"
                className="text-white bg-blue-400 p-3 mt-3"
                onClick={onSave}
            >
                Save
            </button>
